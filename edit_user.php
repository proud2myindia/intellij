...
if(isset($_POST['edit_user']))
{
    ...
    $user_mod_date = $conglobal->crntdatetime;
    ...
    if($flag == 1)
    {
        ...
        if(!empty($_POST['user_password']))
        {
            ...
            $user_personal_details_data['user_password'] = $pass;
        }

        if($ret = $user->editUser($user_personal_details_data,$user_id))
        {
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="personal_details" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="First Name" name="user_fname" value="<?php echo $dis_user['user_fname'];  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="Last Name" name="user_lname" value="<?php echo $dis_user['user_lname'];  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="User Name" name="user_name" value="<?php echo $dis_user['user_name'];  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="Contact No" name="user_contact" value="<?php echo $dis_user['user_contact'];  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="Email" name="user_email" value="<?php echo $dis_user['user_email'];  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="submit" class="btn btn-info"  name="edit_user" value="Edit User">
