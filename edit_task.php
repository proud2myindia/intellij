...
if(isset($_POST['add_task']))
{
    ...
    $dateUpdated = $conglobal->crntdatetime;
    ...
    if($flag == 1)
    {
        ...
        if($ret = $task->updateTask($task_details_data,$task_id))
        {
...
$dis_task = $task->getTaskById($task_id);
?>
                ...
                <div class="col-md-9">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Edit </strong>Task</h1>
                            <ul class="controls">
                                <li class="dropdown">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="personal_details" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="Task Name" name="name" value="<?php if(!empty($dis_task['name'])){echo $dis_task['name'];}  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" id="inputEmail3" placeholder="Description" name="description" ><?php if(!empty($dis_task['description'])){echo $dis_task['description'];}  ?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="task_create_user_id" class="form-control">
                                                    ...
                                                    {
                                                        ?>
                                                        <option value="<?php echo $du['user_id']; ?>" <?php if($dis_task['task_create_user_id'] == $du['user_id']){ echo 'selected';}  ?>><?php echo $du['user_fname'].''.$du['user_lname'];   ?></option>
                                                        <?php
                                                    }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="submit" class="btn btn-info"  name="add_task" value="Edit Task">
