...
$ret = $sales->addTempSales($data);

$dis = $sales->getAllTempSales();
$i = 1;

$s = 0;
$tot_tax = 0;

$cnt_temp_sales = $sales->getNoTempSales();
...
foreach ($dis as $d) {
    ...
    <tr style="background-color: #a2afc8">
        ...
        <td><input type="text" id="qty<?php echo $i;   ?>" name="product_qty[]" value="1" onkeyup="javascript: getSalesTotal(this.value,document.getElementById('price_id'+<?php echo $i;   ?>).value,document.getElementById('tax_id'+<?php echo $i;   ?>).value,<?php echo $i;  ?>,<?php echo $cnt_temp_sales;   ?>);"></td>
